  ...
  <div className="add-form">
    <form>
      <Container 
        ...
        maxWidth="xs"
        className="new">
        <TextField className="habit" id="bit4" label="Goal Habit" required/>
        <TextField className="habit" id="bit1" label="bit 1" required/>
        <TextField className="habit" id="bit2" label="bit 2" required/>
        <TextField className="habit" id="bit3" label="bit 3" required/>
