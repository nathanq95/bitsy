...
describe('/overview', () => {
  ...
  it ('should receive a 200 response if data exists for the given id', async (done) => {
    const data = {
      habit_1: 'a',
      habit_2: 'b',
      habit_3: 'c',
  ...
  it ('should receive a 204 response if data does not exist for the given id', async (done) => {
    request(app)
      .get('/api/overview')
      .send({id: 1})
      .expect(204)
